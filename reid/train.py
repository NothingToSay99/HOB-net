...
from layers import make_loss, make_loss_with_center,make_reanked_loss
...
def train(cfg):
    ...
    if cfg.MODEL.IF_WITH_CENTER == 'no' and cfg.MODEL.METRIC_LOSS_TYPE == 'triplet':
    ...
    elif cfg.MODEL.IF_WITH_CENTER == 'no' and cfg.MODEL.METRIC_LOSS_TYPE == 'ranked_loss':
        print('Train without center loss, the loss type is', cfg.MODEL.METRIC_LOSS_TYPE)
        optimizer = make_optimizer(cfg, model)
        # scheduler = WarmupMultiStepLR(optimizer, cfg.SOLVER.STEPS, cfg.SOLVER.GAMMA, cfg.SOLVER.WARMUP_FACTOR,
        #                               cfg.SOLVER.WARMUP_ITERS, cfg.SOLVER.WARMUP_METHOD)
        ...
        #     loss_func = make_reanked_loss(cfg, num_classes)     # modified by gu
        # if cfg.MODEL.METRIC_LOSS_TYPE == 'triplet':
        loss_func = make_reanked_loss(cfg, num_classes)
