...
_C.MODEL.HOB_NUM = 'hob1'

_C.MODEL.METRIC_LOSS_TYPE_ ='softmax_triplet_only'

_C.MODEL.INPUT_CHANNLS = 2048

_C.MODEL.EMBEDINGS = 512

_C.MODEL.INTER_CHANNLS = 512
...
_C.DATASETS.CUHK03L = 'labeled'
# Root directory where datasets should be used (and downloaded if not found)
# _C.DATASETS.ROOT_DIR = ('/root/data/HOB/reid-strong-baseline-master/data')
_C.DATASETS.ROOT_DIR = ('/root/data/HOB1217/data')
# -----------------------------------------------------------------------------
# DataLoader
# -----------------------------------------------------------------------------
_C.DATALOADER = CN()
...
_C.SOLVER.ALPHA = 2.0
_C.SOLVER.TVAL = 1.0
_C.SOLVER.RANKED_LOSS_WEIGHT = 0.4
# Balanced weight of center loss
_C.SOLVER.CENTER_LOSS_WEIGHT = 0.0005
# Balanced weight of triplet loss
_C.SOLVER.TRIPLET_LOSS_WEIGHT = 0.1
_C.SOLVER.TRIPLET_LOSS_WEIGHT_FIRST = 1.0
